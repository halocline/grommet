...
export const doc = Pagination => {
  ...
  DocumentedPagination.propTypes = {
    ...
    onChange: PropTypes.func
      ...
      arrow button. The single argument is an event containing the latest page 
      via \`event.page\`, and the startIndex and endIndex for data on this page 
      via \`event.startIndex\` and \`event.endIndex\`, respectively.`,
      )
      .defaultValue(undefined),
    page: PropTypes.number
      .description(
        `The default page. If used with onChange, it can be used to 
      control the active page via state.`,
      )
      .defaultValue(1),
